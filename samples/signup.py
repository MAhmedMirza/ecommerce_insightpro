...
<head>
    ...
    <title>Sign Up | E-Commerce InsightPro</title>
...
<body>
        ...
        <div class="signup-form">
            <form method="POST" action="/signup">
                ...
                <div class="login-link">
                    Already have an account? <a href="/login" onclick="event.preventDefault(); window.location.href='/login'">Log in</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Close when clicking outside the signup container
...
if __name__ == '__main__':
    app.run(port=5000)  # Different port for signup
